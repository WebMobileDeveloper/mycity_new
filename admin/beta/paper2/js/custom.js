...
$(document).on('click', '.updateUserProf', function()
{
    ...
    if(is_business ==  1)
    {
        ...
        var busi_location_edit = $('input[name="busi_location_edit"]').val();
        var busi_type_edit = $('input[name="busi_type_edit"]').val();
...
$(document).on('click', 'select[name=membertype_edit]', function(e) {
       ...
       if($(this).val() == 0 ) 
       {
        $('input[name=busi_name_edit]').prop("disabled", true);
           $('input[name=busi_location_edit]').prop("disabled", true);
           $('input[name=busi_type_edit]').prop("disabled", true);
       ...
       else 
       {
        $('input[name=busi_name_edit]').prop("disabled", false);
           $('input[name=busi_location_edit]').prop("disabled", false);
           $('input[name=busi_type_edit]').prop("disabled", false);
