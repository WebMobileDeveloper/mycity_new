        ...
        <nav class="navbar navbar-default">
            <div class="container-fluid">
                <div class="navbar-header">
                    ...
                    <p class="navbar-brand" href="#">Client / User Details</p>
                </div>
                            ...
                            <div class="content">
                                <div class="row">
                                    ...
                                    <div class="col-xs-7">
                                        <div class="numbers">
                                            <p>New Member(s)</p>
                                            <span data-value='<?php echo $totalsignup['signupcnt'];?>' class="count"></span>
                                        </div>
                                    </div>
                                </div>
                                <div class="footer">
                                    <hr />
                                    <div class="stats">
                                        <i class="ti-reload"></i> Total New signup Today
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="card">
                            <div class="content">
                                <div class="row">
                                    ...
                                    <div class="col-xs-7">
                                        <div class="numbers">
                                            <p>Total Referral Mail(s)</p>
                                           <span data-value='<?php echo $emailsentlog['emailcnt'];?>' class="count"></span>
                                        </div>
                                    </div>
                                </div>
                                <div class="footer">
                                    <hr />
                                    <div class="stats">
                                        <i class="ti-reload"></i> Total Referral Mails Sent Today
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="card">
                            <div class="content">
                                <div class="row">
                                    ...
                                    <div class="col-xs-7">
                                        <div class="numbers">
                                            <p>Referrals Matched</p>
                                          <span data-value='<?php echo $totalref['cnt']; ?>' class="count"></span>
                                        </div>
                                    </div>
                                </div>
                                <div class="footer">
                                    <hr />
                                    <div class="stats">
                                        <i class="ti-reload"></i> Total Referrals Matched
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="content">
                                <div class="row">
                                    ...
                                    <div class="col-xs-7">
                                        <div class="numbers">
                                            <p>Total Referrals</p>
                                            <span data-value='<?php echo $mytotalref ;?>'  class="count"></span>
                                        </div>
                                    </div>
                                </div>
                                <div class="footer">
                                    ...
                                    <a data-toggle="tab" href="#" class="ref_wizard" aria-expanded="true">
                                      <i class="ti-reload"></i> Send Referral</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="content">
                                <div class="row">
                                    ...
                                    <div class="col-xs-7">
                                        <div class="numbers">
                                        <p>Total Knows</p>
                                        <span data-value='<?php echo getMyKnows($link, $user_id); ?>'  class="count"></span>
                                        </div>
                                    </div>
                                </div>
                                <div class="footer">
                                    <hr />
                                    <div class="stats">
                                    <a  data-toggle="tab" href="#menu2"   ><i class="ti-reload"></i> Add New Know</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="content">
                                <div class="row">
                                    ...
                                    <div class="col-xs-7">
                                        <div class="numbers">
                                            <p>Total Partners</p>
                                            <span data-value='<?php echo  $resconnections->num_rows ; ?>'  class="count"></span>
                                        </div>
                                    </div>
                                </div>
                                <div class="footer">
                                    ...
                                    <hr />
                                    <div class="stats">
                                        <i class="ti-reload"></i> These partners have added <?php echo $totalconnections; ?> knows
                                    </div>
										</a>
                                </div>
                            </div>
                            ...
                            <div class="content">
                                <div class="row">
                                    ...
                                    <div class="col-xs-7">
                                        <div class="numbers">
                                            <p>Reward Points</p>
                                            <span data-value='<?php echo getLoyaltyPoint($link, $user_id);  ?>' class="count"></span>
                                        </div>
                                    </div>
                                </div>
                                <div class="footer">
                                    <hr />
                                    <div class="stats">
                                        <i class="ti-timer"></i> Overall reward score so far.
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="content">
                                <div class="row">
                                    ...
                                    <div class="col-xs-7">
                                        <div class="numbers">
                                            <p>Total Partners</p>
                                            <span data-value='<?php echo   $totalpartners ; ?>'  class="count"></span>
                                        </div>
                                    </div>
                                </div>
                                <div class="footer">
                                    ...
                                    <a  data-toggle="tab" href="#menu37" data-role='0' data-page='1' class='btnknowreport'  >
                                       <i class="ti-timer"></i>View Knows Added
                                    </a> 
                                    </div>
                                </div>
                            </div>
