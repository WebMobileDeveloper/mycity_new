...
include_once("template/indexhead.php");
...
?>
    <section id="main-section" class="welcome-sec next-sections">
        <div class="container">
            <div class="row">
                <div class="col-md-12 col-xs-12 col-sm-12 text-center"  id="signup">
                    <h3 >Welcome to MyCity</h3>
                    <h4>Where business people come to network</h4>
    ...
    <section id="sec_two" class="next-sections form-large">
        <div class="container">
            <div class="row">
    ...
    <section id="sec_five" class="next-sections form-large">
        <div class="container">
            <div class="row">
                <form>
                    <div class="col-md-12">
    ...
    <section id="sec_six" class="next-sections form-large">
        <div class="container">
            <div class="row">
                <form>
                    <div class="col-md-12">
                        <h1 class="description">Select your group</h1>
                    </div>
                        ...
                        <div class="multi-select ages groups_append" data-name="ages" data-required="1" data-max="3" data-numbered="0" data-clearable="1">
                            <div class="form-group">
                                <select name="groups[1]" data-name="ages" class="form-control select2 signup select2-hidden-accessible"
                                        data-class="form-large" tabindex="-1" aria-hidden="true">
                                    <option value="null">Group type</option>
                                    <?php
    ...
    <section id="sec_seven" class="next-sections form-large">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
    ...
    <section id="sec_ten" class="next-sections form-large">
        <div class="container">
            <div class="row">
                <form>
                    <div class="col-md-12">
                    ...
                    <div class="col-md-4 col-md-offset-4 logo-background">
                        <div class="form-group">
                            <div class="change-photo">
                                <div class="img">
                                    <img id="blah" src="http://mycity.com/images/no-photo.png" style="border-radius: 50%;" alt="abc">
...
<?php include("template/indexfooter.php") ?>