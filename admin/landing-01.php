...
<article>
  ...
  <p class='into-text'>Participate in a group in your area. 
                    ...
                    <div class="col-md-4 ">
                        <select class='form-control form-control2' name='landingcity'>
                            <option>Select City</option> 
                             <?php 
                                while($row = $groups->fetch_array()){
                                    echo "<option value='" . $row['grp_name'] . "'>" . $row['grp_name'].  "</option>"; 
                            } 
                            ?>
                        </select>
                    </div>
                    <div class="col-md-4 ">
                        <input class='form-control form-control2' placeholder='Zip Code' name='landingzip'/>
                    </div>
                    <div class="col-md-3">
                    <button type='submit' name='btnlandingsignup' class='btn btn-blue'>Signup</button>
                    </div>
                        </form>
