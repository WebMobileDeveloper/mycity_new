...
if ($userPkgQ->num_rows > 0) {
    ...
    $user_shortcode = $userPkgFet['user_shortcode'];
}
    ...
    <div class="content">
        <div class="container-fluid">
            <div class='row visible-xs'>
                <div class='col-md-12'>
                    <p class="">
                        <button type="button" class="btn btn-primary btn-xs " data-toggle="offcanvas">Main Menu</button>
                    </p>
                </div>
            </div>
                            ...
                            <div id="tbc" class="carousel slide infoalertzone" data-ride="carousel">
                                <ol class="carousel-indicators">
                                    ...
                                    <?php if ($programstatus == 0 && $_user_role != 'admin') { ?>
                                        <li data-target="#tbc" data-slide-to="2"></li> <?php } ?>
                                </ol>
                                    ...
                                    <?php if ($programstatus == 0 && $_user_role != 'admin') { ?>
                                        <div class="item carousel-entice active">
                                            <div class=" pad10 margb3 text-center">
                                                ...
                                                <p>
                                                    <button data-toggle="tab" data-ppid='<?php echo $participantid; ?>' class="btn btn-orange join3tprogram"><i class="fa fa-link"></i>Join Program Now
                                                    </button>
                                                </p>
                                            </div>
                                        </div>
                                    <?php } ?>
                                    <div class="item <?php if ($programstatus == 1 || $_user_role == 'admin') {
                                        echo "active";
                                    } ?>">
                                        <div class=" pad10 margb3 text-center">
                        ...
                        <div class="panel-body panel-menu">
                            <ul id='peopleknow'>
                                ...
                                <?php if ($_user_role == 'admin') { ?>
                                    ...
                                    <li><a href="<?PHP echo $siteurl;?>/invite-knows"><i class="fa fa-bar-chart"></i> Generate Join mycity Landing Page</a></li>
                                ...
                                <?php if ($_user_role == 'admin') { ?>
                                    ...
                                    <li><a data-toggle="tab" title='Show Unfinished Signups' data-page='1' href="#menu48" class='viewunfinishedsignup'><i class="fa fa-user"></i> Incomplete Signups</a>
                                    </li>
                                    ...
                                    <li><a data-toggle="tab" title='Manage Rated 6 Invites' class='load_rated6invites' href="#menu88"><i class="fa fa-bar-chart"></i> Manage Rated 6 Invites</a></li>
                                <?php } ?>
                            </ul>
                        </div>
                    </div>
                        ...
                        <div class="panel-body panel-menu">
                            <ul>
                                ...
                                <li><a data-toggle="tab" href="#menu25" class='loadimportedknows'><i class="fa fa-users"></i> Manage Imported Knows</a>
                                    <a href="<?php echo $help_d0ata_buttxsons[10]['helpvideo']; ?>" target="_blank"><i id='hint-profile1' class='fa fa-arrow-right'></i><span
                                                style="color:red;">Help</span></a>
                                </li>
                                ...
                                <li><a data-toggle="tab" title='Generate a report] of imported LinkedIn Contacts' class='linkedinimportlist' href="#menu40"><i class="fa fa-linkedin"></i>View Imported
                                        LinkedIn Contacts</a></li>
                    ...
                    <div class="tab-content">
                        <div class="row">
                            <div class='col-xs-12 col-md-12'>
                                <div class="tab-content">
                                    ...
                                    <div id="menu81" class="tab-pane maintab">
                                        ...
                                        <div class="col-xs-12 col-md-12  ">
                                            <form class='form-inline form-gray'>
                                                ...
                                                <button type='button' class="btn btn-primary btnblock searchimportedliest">Search</button>
                                            </form>
                                    ...
                                    <!-- menu88 -->
                                    <div id="menu88" class="tab-pane maintab  ">
                                        <div class="top-head">
                                            <div class="col-xs-12 col-sm-8">
                                                <h4>Rated 6 Knows Invited to join mycity.com</h4>
                                            </div>
                                        </div>
                                        <div class="col-md-12 marg40">
                                            <div id='invitedrated6list'></div>
                                        </div>
                                    </div>
                                    <!--menu88 -->
                                        ...
                                        <div id="menu85" class="tab-pane maintab  ">
                                            ...
                                            <div class="col-xs-12 col-md-12 ">
                                                <form class='form-inline form-gray'>
                                                    ...
                                                    <button type='button' class="btn btn-primary btnblock btn_searchstaff">Search</button>
                                                </form>
                                    ...
                                    <div id="menu40" class="tab-pane maintab">
                                        ...
                                        <div class="col-xs-12 col-md-12  ">
                                            <form class='form-inline form-gray'>
                                                ...
                                                <button type='button' class="btn btn-primary btnblock filterlinkedincontact">Search</button>
                                            </form>
                                    ...
                                    <div id="menu42" class="tab-pane maintab">
                                        ...
                                        <div class="col-xs-12 col-sm-10 padd-5">
                                            ...
                                            <div class="col-sm-12 col-xs-12">
                                                <div id="comvoc"></div>
                                                <select data-placeholder='Choose vocations ...' multiple class="form-control chosen-select  common_vocations" name="common_vocations[]"
                                                        id="common_vocations">
                                                    <?php
                                                    foreach ($vocations as $vocation) {
                                                        echo "<option value='" . $vocation['name'] . "'>" . $vocation['name'] . "</option>";
                                                    ...
                                                    <div class='row'>
                                                        ...
                                                        <div class="col-xs-12 col-sm-12">
                                                            <div class="form-group">
                                                                ...
                                                                <select data-placeholder='Choose vocations ...' multiple class="form-control chosen-select dmvocations" name="dmvocations[]"
                                                                        id="dmvocations">
                                                                    <?php
                                                                    foreach ($vocations as $vocation) {
                                                                        echo "<option value='" . $vocation['name'] . "'>" . $vocation['name'] . "</option>";
                                                ...
                                                <div class='row'>
                                                    <div class="col-xs-12 col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <select data-placeholder='Specify Tags ...' multiple name="reversetracktags" class="form-control chosen-select reversetracktags"
                                                                    id="reversetracktags">
                                                                <?php
                                    ...
                                    <div id="menu17" class="tab-pane fade maintab">
                                        ...
                                        <div class="col-xs-12 col-sm-6  ">
                                            <div class='infobox'>
                                                <p>You are currently working on Page <span id='cpage'>1</span>
                                                    <button data-pageno='0' class='btn btn-primary btn-xs savesuggestcpage'>Save Current Working Page</button>
                                                </p>
                                            </div>
                                    ...
                                    <div id="menu21" class="tab-pane fade maintab">
                                        <div class="top-head">
                                            <div class="col-xs-12 col-sm-6">
                                                <h4>Referral Suggestion Mailbox <a href="<?php echo $help_data_buttons[2]['helpvideo']; ?>" target="_blank"><i class='fa fa-arrow-right'></i><span
                                                                style="color:red;"> Help</span></a></h4>
                                            </div>
                                        ...
                                        <div class="col-xs-12 people-know">
                                            <form class='form-inline form-gray'>
                                                ...
                                                <button class="btn btn-primary btnblock searchmailbox">Search</button>
                                            </form>
                                        </div>
                                        <div class="col-xs-12 col-sm-12  ">
                                            ...
                                            <div class='marg4'>
                                                ...
                                                <ul class="nav nav-tabs" role="tablist">
                                                    <li role="presentation" class="active"><a href="#home" data-mf="0" class="btn-mailfilter loadmyinbox " aria-controls="home" role="tab"
                                                                                              data-toggle="tab">Referral Mails</a></li>
                                                    <li role="presentation"><a href="#profile" data-mf="1" class="btn-mailfilter  loadtriggerinbox" aria-controls="profile" role="tab"
                                                                               data-toggle="tab">Trigger Mails</a></li>
                                                    <li role="presentation"><a href="#messages" data-mf="1" class="btn-mailfilter loadlinkedininvites" aria-controls="messages" role="tab"
                                                                               data-toggle="tab">LinkedIn Contacts</a></li>
                                                    <li role="presentation"><a href="#settings" data-mf="3" class="btn-mailfilter loaddirectconnectionmail" aria-controls="settings" role="tab"
                                                                               data-toggle="tab">Direct Connection Mails</a></li>
                                                </ul>
                                    ...
                                    <div id="menu21b" class="tab-pane fade maintab">
                                        <div class="top-head">
                                            ...
                                            <div class="col-xs-12 col-sm-10">
                                                <form class='form-inline form-gray'>
                                                    ...
                                                    <button class="btn btn-primary btnblock searchmailbox"><i class='fa fa-search'></i> Search</button>
                                                </form>
                                            </div>
                                        ...
                                        <div class="col-xs-12 col-sm-12  ">
                                            ...
                                            <div class='marg4'>
                                                ...
                                                <!-- Nav tabs -->
                                                <ul class="nav nav-tabs" role="tablist">
                                                    <li role="presentation" class="active"><a href="#homein" data-mint="0" class="loadinbox" aria-controls="homein" role="tab" data-toggle="tab">
                                                            Messages</a></li>
                                                    <li role="presentation"><a href="#conreqin" data-mint="10" class="loadinbox" aria-controls="conreqin" role="tab" data-toggle="tab"> Connection
                                                            Requests</a></li>
                                                </ul>
							...
							<button class="btnblock">SEARCH PAGE</button>
                                    ...
                                    <?php if ($_user_role == 'admin') { ?>
                                            ...
                                            <div class="row marg40 clearfix" id='tl_box'>
                                                ...
                                                <div class='col-md-12'>
                                                    <div class="tl-box">
                                                        ...
                                                        <div class="pad10 ">
                                                            <hr/>
                                                            <a href="javascript:void(0);" class="btn btn-primary btnassignemail" id="add">Add New Email</a>
                                                        </div>
                                                    </div>
                                        ...
                                        <div id="menu71" class="tab-pane maintab fade">
                                            ...
                                            <div class="col-xs-12 col-sm-12 marg40">
                                                ...
                                                <ul class="nav nav-tabs navactionlog" role="tablist">
                                                    <li role="presentation" class="active"><a href="#voicemail_tab" aria-controls="homein" role="tab" data-toggle="tab"> Clients with Voice Mail</a>
                                                    </li>
                                                ...
                                                <div class="top-head" id='voicemailform'>
                                                    ...
                                                    <div class='col-md-12'>
                                                        ...
                                                        <div class="tl-box">
                                                            ...
                                                            <div class="pad10 ">
                                                                <hr/>
                                                                <a href="#voicemailform" style='color: #fff'>To add new voicemail scroll to top</a>
                                                            </div>
                                        ...
                                        <div id="menu74" class="tab-pane maintab">
                                            <div class="col-xs-12 col-md-12">
                                                <div class='panel panel-default  panel-success'>
                                                    <div class='panel-heading'><h2>Manage Program Questions</h2></div>
                                                    <div class='panel-body'>
                                                        ...
                                                        <div class='form-group'>
                                                            ...
                                                            <div class='form-group'><input type='button' id='btnsavequest' class='btn btn-primary' Value='Save Question'/>
                                                ...
                                                <div class="panel-body">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-xs-12 col-md-4" style='padding-top: 10px;'>
                                                            <button class="btn btn-primary btnblock src_all_knows">Search</button>
                                                        </div>
                                                    </div>
                                                    <div class="row marg4">
                                                        <div class="col-xs-12  ">
                                    ...
                                    <div id="menu65" class="tab-pane maintab">
                                        <div class="col-xs-12 col-md-6">
                                            <div class="panel panel-default  panel-success">
                                                <div class="panel-body"><p><strong>Request to list New City</strong></p>
                                                    <hr>
                                                ...
                                                <form class='  form-gray-wide '>
                                                    <div class='row'>
                                                        ...
                                                        <div class="col-xs-12 col-sm-12">
                                                            <div class="form-group">
                                                                <label>Vocation:</label>
                                                                <select data-placeholder='Choose vocations ...' multiple class="form-control chosen-select dmvocations2" name="dmvocations2[]"
                                                                        id="dmvocations2">
                                                                    <?php
                                                                    foreach ($vocations as $vocation) {
                                                                        echo "<option value='" . $vocation['name'] . "'>" . $vocation['name'] . "</option>";
                                    ...
                                    <div id="menu59" class="tab-pane maintab">
                                        <div class="col-xs-12 col-md-12">
                                            <!-- Nav tabs -->
                                            <ul class="nav nav-tabs" role="tablist">
                                                <li role="presentation" class="active"><a href="#conreqsent" data-mf="0" class="btn-mailfilter getconnectionrequest " aria-controls="home" role="tab"
                                                                                          data-toggle="tab">Request Sent</a></li>
                                                <li role="presentation"><a href="#conreqreceived" data-mf="1" class="btn-mailfilter  getconnectioninrequest" aria-controls="profile" role="tab"
                                                                           data-toggle="tab">Request Received</a></li>
                                            </ul>
                                            <!-- Tab panes -->
                                            <div class="tab-content">
                        ...
                        -->
                                    ...
                                    <div id="viewpost" class="tab-pane maintab">
                                        ...
                                        <div class="col-xs-12 col-md-12  " id='comment'>
                                            <hr/>
                                            <h3>Leave a Reply</h3>
                                    ...
                                    <div id="menu1" class="tab-pane active maintab">
                                        <div class='grid-row no-padd'>
                                            <div class="top-head">
                                                <div class="col-xs-12 col-sm-8">
                                                    <h4>Client / User Details <a href="<?php echo $help_data_buttons[0]['helpvideo']; ?>" target="_blank"><i id='hint-profile1'
                                                    ...
                                                    <div class="panel-body">
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-4">
                                                                ...
                                                                <br/><a href="#" data-toggle='modal' data-target='#changepicture' class="btn-primary btn btn-xs changepic_btn marg1"
                                                            ...
                                                            <div class="col-md-12">
                                                                ...
                                                                if ($profileisvisible == '1') {
                                                                    ...
                                                                    <?php if ($user_shortcode != '') { ?>
                                                                        <a target='_blank' href="<?php echo $siteurl; ?>profile/<?php echo $user_shortcode ?>"><?php echo $siteurl; ?>
                                                                            profile/<?php echo $user_shortcode; ?></a>
                                                                    <?php } ?>
                                                                    <br/>
                                                ...
                                                if ($_user_role != 'admin') :
                                                    ...
                                                    <div class="panel panel-default panelhome">
                                                        ...
                                                        <div class="panel-body  ">
                                                            ...
                                                            <p>
                                                                <strong>Step 1:</strong> Go to <a target='_blank' class='blue' href='https://www.linkedin.com/psettings/member-data'>https://www.linkedin.com/psettings/member-data</a>
                                                                <br/>
                                    ...
                                    <div id="menu2" class="tab-pane fade maintab">
                                        <div class="top-head">
                                            <div class="col-xs-12 col-sm-8">
                                                <h4>ENTER PEOPLE YOU KNOW DETAILS
                                                    <a href="<?php echo $help_data_buttons[7]['helpvideo']; ?>" target="_blank"><i class='fa fa-arrow-right'></i><span
                                                                style="color:red;"> Help</span></a>
                                                </h4>
                                            </div>
                                            <div class="clearfix"></div>
                                        ...
                                        <div class='row'>
                                            <div class="col-xs-12 col-sm-6 padd-5">
                                                ...
                                                <label class="custom-label">Lifestyle: <strong>( In case your city is not listed, request to list it <a data-toggle='tab' data-dismiss='modal'
                                                                                                                                                        aria-label='Close'
                                                                                                                                                        href='#menu65'>here</a>.)</strong>
                                                </label>
                                            ...
                                            <div class='globalsearch'>
                                                ...
                                                <div class="row  ">
                                                    ...
                                                    <div class="col-xs-12 col-md-2 " style='padding-top: 10px;'>
                                                        <button class="btn btn-primary btnblock srchRef">Search</button>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="pagesData">
                                                    <div id="pages_edit">
                                                        <div class="top-head">
                                                            <div class="col-xs-12 col-sm-8">
                                                                <h4>Services & Pricing
                                                                    <button class="btn btn-primary btnblock" data-toggle="modal" data-target="#edit_package">Add Packages</button>
                                                                </h4>
                                                            </div>
                                                            <div class="clearfix"></div>
                                                        </div>
