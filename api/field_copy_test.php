<?php 
	...
	//missing fields copy
	$sql_query = " select * from user_people where client_phone ='' and check_fields in (0,1) order by id desc  ";
	...
	while($item = $members->fetch_array()):
		...
		( client_phone <> '' and  client_location <> '' and  
		  client_phone is not NULL   and  client_location is not NULL )  "; 
		...
		$update_query = "update user_people  set   check_fields = '100'  where client_email='$email'"; 
		$link->query($update_query);  
