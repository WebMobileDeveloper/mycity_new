...
$(document).on('click', '.btnconnect', function () {
    ...
    var sub_page = $(this).attr('sub-pg');
    var memberid = $(this).attr('data-i');
    var form = $('<form action="' + siteurl + 'business/search/"'+sub_page+' method="post">' +
...
$(document).on('click', '.btncomposeknowinvitemail', function () {
    ...
    var form = $('<form id="claim_profile" action="' + siteurl + 'business/search/knows/" method="post">' +
