<section id="sec_member_address" class="next-sections form-large" style="display: block; pointer-events: auto;">
	 ...
	 <div class="col-md-8 col-md-offset-2 ">				
                   <div class="form-group ">
                        <select name="country" class="form-control select2 signup select2-hidden-accessible" data-placeholder="Country" data-class="form-large" tabindex="-1" aria-hidden="true">
	...
	<div class="col-md-8 col-md-offset-2 "> 
	 ...
	 <div class="col-md-4   ">
		<div class="form-group hidden">
			<select name="province" class="form-control select2 signup select2-hidden-accessible" data-placeholder="Province" data-class="form-large" tabindex="-1" aria-hidden="true">
                            <option></option>
  ...
  <div class="col-md-4   ">
			<div class="form-group">
                        <input name="zip" type="text" class="form-control" placeholder="ZIP" value="">
                        <label class="message"></label>
                        <span class="required">*</span>
                    </div>	  
      </div>
	  ...
	  <div class="col-md-8 col-md-offset-2  "> 
			<div class="form-group">
				<button type="submit" name='regUserAddress' value='save_address' class="btn btn-block button green submit regUserAddress">Next</button>
			</div>
	</div> 
