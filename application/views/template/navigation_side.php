...
<div class='col-md-3 sidepane'> 
  ...
  <div class="carousel-inner " role="listbox"> 
	...
	<div class="item carousel-entice active">
		...
		<?php  echo form_open(); ?>
		<p><button type='submit' name='btn_join_prg' value='join_program' class="btn btn-orange join3tprogram" ><i class="fa fa-link"></i>Join Program Now</button>
...
<div class="item active ">
    ...
    <div class="item">
      <div class=" pad10 margb3 text-center"> 
		 <h4>Introduce highly rated people to people you know in their area.</h4>
		 <br/>
		 <p><a   href="<?php echo $base; ?>my-network/add/" class="btn btn-primary" class="btn btn-primary" ><i class="fa fa-user-plus"></i>Click here to add your know!</a></p>
		<br/>
		<br/>	
	</div>
    </div> 
...
<div class="panel panel-default">
 ...
 <div class="panel panel-default">
				...
				<div class="panel-body panel-menu">
					...
					<?php if($_user_role == 'admin'  ) { ?>
						<li><a  title='Reverse Tracking of Partners' href="<?php echo $base; ?>dashboard/reverse-tracking" class='showreversetrackpane' ><i class="fa fa-user"></i> Reverse Tracking</a></li>
