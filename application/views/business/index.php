<div class='col-md-9'>
    ...
    if ($nearest_knows['member_count'] > 0): ?>
        <div class='profile-item'>
            <h2>Member Search Result</h2>
            <div class='hr-sm '></div>
            <div class='marg2'></div>
            <form method='post' style='display:inline' action='<?php echo $base; ?>business/search/<?php echo $offset; ?>'>
                <button type="submit" name='vu_member' value='1' class='btn btn-primary btn-sm vuconcount'>Members</button>
            </form>

            <form method='post' style='display:inline' action='<?php echo $base; ?>business/search/knows'>
                <button type="submit" name='vu_know' value='1' class='btn btn btn-sm vuconcount' style='color:#000'>Their Knows</button>
            </form>
            <hr/>
            <div role="tabpanel" class="tab-pane" id="membergrid">
                <div class="memberlist">
                    ...
                    foreach ($nearest_knows['result']->result() as $item) {
                        ...
                        if ($item->isconnected == 1) {
                            ...
                            $html .= '<button type="button" data-i="' . $item->ui . '" sub-pg="" data-pg="' . $offset . '" data-tgt="" class="btn btn-primary btn-solid btn-block btnconnect" ><i class="fa fa-envelope"></i> Connect</button>';
                        }
