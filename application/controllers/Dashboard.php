...
//		}
        ...
        $search_email = '';
        $name_profession = '';
        if ($this->input->post("btn-toprate-search") == "btn-toprate-search") {
        ...
        $rated_knows = $this->Knows->get_top_rated_knows(array('ranking' => '25', 'offset' => $offset,
            'name_profession' => $name_profession, 'search_email' => $search_email));
        $pagedata['rated_knows'] = $rated_knows;
        $pagedata['offset'] = $offset;
        $pagedata['search_email'] = $search_email;
        $pagedata['name_profession'] = $name_profession;
